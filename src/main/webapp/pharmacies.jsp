		...
		<div class="row mt-5">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="PharmacieController?id=<%=p.getId()%>&op=localisation" class="btn btn-link btn-sm mr-2"> <i class="fas fa-edit"></i>Localisation
                        <a href="PharmacieController?id=<%=p.getId()%>&op=update" class="btn btn-link btn-sm mr-2"> <i class="fas fa-edit"></i>Modifier</a> 
					    <a href="PharmacieController?id=<%=p.getId()%>&op=delete"class="btn btn-link btn-sm"> <i class="fas fa-trash-alt"></i>Supprimer</a>
					</td>
